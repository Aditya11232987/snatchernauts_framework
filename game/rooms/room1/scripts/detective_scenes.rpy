...
label detective_talk_scene:
    ...
    $ show_letterbox(duration=0.6, wait_for_animation=False)
    ...
    $ hide_letterbox(duration=0.6, wait_for_animation=False)
    return
...
label detective_ask_about_scene:
    ...
    $ show_letterbox(duration=0.8, wait_for_animation=True)
    ...
    $ hide_letterbox(duration=0.8, wait_for_animation=True)
